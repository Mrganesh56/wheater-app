...
// // Cordinates(longitute,latitude) ,temp , pressure, humitidty, wind speed, sunrise and sunset
...
//     return (
//        <div className="flex items-center bg-while border-gray-200"
//     )
// }
...
//             <span className="font-bold">Temperature:</span> {Math.round(weatherData?.main?.temp-273)}
//           </p>
//           <p className="mb-2 font-normal  font-sans">
